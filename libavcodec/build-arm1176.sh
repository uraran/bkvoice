...
export SDK_DIR=$PWD/install_sdk/arm1176/
...
make distclean
chmod +x configure
./configure --prefix=$SDK_DIR --enable-shared --enable-static --host=arm-none-linux-gnueabi #--enable-fixed-point 使用VFP
make -j5
make install
popd
...
#FOR S3C2440
make clean
make ARM1176=yes TOOLCHAIN_PREFIX=arm-none-linux-gnueabi-
